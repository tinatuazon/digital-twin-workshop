              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href={`tel:${portfolioData.personal.phone}`} className="text-sm text-zinc-400 hover:text-cyan-400 transition-colors">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-zinc-400">{portfolioData.personal.location}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-zinc-400">{portfolioData.personal.workingHours}</p>
                  </div>
                </div>
              </div>
